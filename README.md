...
Project Overview
The Mental Health Analytics Dashboard is an interactive Excel dashboard that analyzes mental health survey data to uncover patterns in stress levels, mental health conditions, treatment-seeking behavior, workload, sleep quality, exercise habits, job satisfaction, and demographic characteristics.
...
The average stress level among participants was 5.63 out of 10, indicating moderate stress overall.
...
The most frequently reported mental health conditions were:
...
Treatment-seeking responses were distributed as follows:
Status	Participants	Percentage
Seeking Treatment	162	25.4%
Not Seeking Treatment	153	24.0%
No Response	323	50.6%
Insight: More than half of the respondents did not disclose their treatment status, highlighting potential reporting gaps.
...
•	Anxiety: 47.21 hours
Insight: Participants working longer hours tended to report certain mental health conditions more frequently, suggesting a possible relationship between workload and mental well-being.
...
Average stress levels varied by country:
...
United States	5.22
France	5.07
Insight: Stress levels differ across regions, potentially reflecting variations in workplace environments, social conditions, and cultural attitudes toward mental health.
Recommendations
